...
class Candidate(models.Model):
    ...
    username = models.CharField(max_length=16, verbose_name=u'姓名')
    city = models.CharField(max_length=32, verbose_name=u'城市')
    phone = models.CharField(max_length=16, verbose_name=u'手机号码')
    email = models.EmailField(max_length=128, blank=True, verbose_name=u'邮箱')
    ...
    gender = models.CharField(max_length=8, blank=True, verbose_name=u'性别')
    ...
    test_score_of_general_ability = models.DecimalField(decimal_places=1, null=True, max_digits=3,
                                                        blank=True, verbose_name=u'综合能力测评成绩')
    ...
    # first_interviewer = models.CharField(max_length=64, blank=True, verbose_name=u'面试官')
    ...
    # Python2 优先使用这个方法，把对象转换成字符串；如果没有 __unicode__() 方法，使用 __str__() 方法
    def __unicode__(self):
        return self.username

    # Python3 直接定义 __str__() 方法即可，系统使用这个方法把对象转换成字符串
    def __str__(self):
        return self.username
