...
class CandidateAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('第一轮面试记录', {'fields': (("first_score", "first_learning_ability", "first_advantage"), "first_disadvantage",
                                "first_result", "first_recommend_position", "first_interviewer", "first_remark",)}),
